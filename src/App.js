    ...
    <div>
      ...
      <div className='cards__section'>
        ...
        <p className='cards__description'>
          Own your custom domain username, use it across services, and be able to store an avatar and other profile data.
        </p>
        <hr />
        ...
        <div className='cards'>
          {
            domains.map((domain, idx) => (
              <Domain domain={ domain } ethDaddy={ ethDaddy } provider={  provider } id={ idx + 1 } key={ idx } />
            ))
          }
        </div>
      </div>
